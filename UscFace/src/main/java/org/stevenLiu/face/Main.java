...
public class Main
{
	...
	public static void main(String[] args)
	{
		...
		// usc_face
		HttpRequests httpRequests = new HttpRequests("95ff7f00afe747e682b534a6c88c8918",
		...
		try
		{
			...
			// 1492a15626d6c96ebe26e8f239af380c
			// person/create-----------------------------------
			System.out.println("\nperson/create");
...
*/
			...
			System.out.println("-------train    Recognition-------------------------------------------------------------");
			//-----------------train-----------------
		...
		{
			/*
			 * try { for (int i = 1; i < result.getJSONArray("face").length();
			 * ++i) { httpRequests.personDelete(new
			 * PostParameters().setPersonName("person_" + i));
			 * httpRequests.facesetDelete(new
			 * PostParameters().setFacesetName("faceset_" + i)); } } catch
			 * (JSONException e) { e.printStackTrace(); } catch
			 * (FaceppParseException e) { e.printStackTrace(); }
			 */
		}
